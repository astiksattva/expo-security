...
export function FingerprintDemoScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Fingerprint Demo</Text>
      <Text style={styles.subtitle}>Test fingerprint authentication in demo mode</Text>
      ...
      <View style={styles.demoInfo}>
        <Text style={styles.demoInfoText}>
          In demo mode, authentication is simulated. Real authentication
          requires a device with fingerprint hardware and enrolled fingerprints.
        </Text>
      </View>
      ...
      >
        <Text style={styles.buttonText}>
          {isLoading ? 'Authenticating...' : 'Simulate Fingerprint Auth'}
        </Text>
      </TouchableOpacity>
